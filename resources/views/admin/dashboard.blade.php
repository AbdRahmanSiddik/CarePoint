        ...
        <div class="card project-card">
          <div class="card-header">
            ...
            <div class="dropdown icon-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown7"><a class="dropdown-item"
            ...
            <div class="row align-items-center">
              <div class="col-5 custom-width">
                <div class="progress progress-striped-primary">
                  <div class="progress-bar" style="width: 55%" role="progressbar" aria-valuenow="10" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
                <div class="progress progress-striped-secondary">
                  <div class="progress-bar" style="width: 60%" role="progressbar" aria-valuenow="10" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
                <div class="progress progress-striped-tertiary">
                  <div class="progress-bar" style="width: 45%" role="progressbar" aria-valuenow="10" aria-valuemin="0"
                    aria-valuemax="100"></div>
                </div>
              </div>
      ...
      <div class="col-sm-6 col-xl-3">
        <div class="card investing-card">
          <div class="card-header pb-0">
            <h4>Investing</h4>
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown3" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown3"><a class="dropdown-item"
      ...
      <div class="col-md-6 col-xl-6">
        ...
        <div class="card invoice-card">
          <div class="card-header pb-0">
            <h4>All Invoices</h4>
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown4" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown4"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="flex-grow-1"><a href="user-profile.html">
                            <h6 class="f-w-500">Elle Amberson</h6>
                          </a><span class="font-light f-w-400 f-13">Elle34@gmail.com</span></div>
                      </div>
                    </td>
                    <td>Website</td>
                    <td>10-10-2024</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="flex-grow-1"><a href="user-profile.html">
                            <h6 class="f-w-500">Anna Catmire</h6>
                          </a><span class="font-light f-w-400 f-13">Anna12@gmail.com</span></div>
                      </div>
                    </td>
                    <td>Mobile App</td>
                    <td>15-09-2024</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="flex-grow-1"><a href="user-profile.html">
                            <h6 class="f-w-500">Laura Dagson</h6>
                          </a><span class="font-light f-w-400 f-13">Laura@gmail.com</span></div>
                      </div>
                    </td>
                    <td>Wordpress</td>
                    <td>23-05-2024</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="flex-grow-1"><a href="user-profile.html">
                            <h6 class="f-w-500">Rachel Green</h6>
                          </a><span class="font-light f-w-400 f-13">Rache87@gmail.com</span></div>
                      </div>
                    </td>
                    <td>Service</td>
                    <td>15-02-2024</td>
          ...
          <div class="card-header">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown2" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown2"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
            ...
            <ul>
              <li class="d-flex line-primary">
                ...
                <div class="dropdown task-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown44"><a class="dropdown-item"
                      href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                      class="dropdown-item" href="#">Yearly</a></div>
                </div>
              </li>
              <li class="d-flex line-secondary">
                ...
                <div class="dropdown task-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown55"><a class="dropdown-item"
                      href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                      class="dropdown-item" href="#">Yearly</a></div>
                </div>
              </li>
              <li class="d-flex line-tertiary">
                ...
                <div class="dropdown task-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown66"><a class="dropdown-item"
                      href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                      class="dropdown-item" href="#">Yearly</a></div>
                </div>
              </li>
              <li class="d-flex line-primary">
                ...
                <div class="dropdown task-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown77"><a class="dropdown-item"
                      href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                      class="dropdown-item" href="#">Yearly</a></div>
                </div>
              </li>
              <li class="d-flex line-secondary">
                ...
                <div class="dropdown task-dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown88"><a class="dropdown-item"
                      href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                      class="dropdown-item" href="#">Yearly</a></div>
                </div>
              </li>
      ...
      <div class="col-md-6 col-lg-6 col-xl-7">
        <div class="card">
          <div class="card-header pb-0">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown6" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown6"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
          ...
          <div class="card-header pb-0">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown01" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown01"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
          ...
          <div class="card-header pb-0">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown1" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown1"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img
                            src="{{ asset('') }}assets/images/dashboard1/invest/01.jpg" alt=""></div>
                        <div class="flex-grow-1"> <a href="user-profile.html">
                            <h6 class="f-w-500">Civil engineering</h6>
                          </a><span class="font-light f-w-400 f-13">20h 10m</span></div>
                      </div>
                    </td>
                    <td>$150</td>
                    <td>UX/UI Design</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img
                            src="{{ asset('') }}assets/images/dashboard1/invest/02.jpg" alt=""></div>
                        <div class="flex-grow-1"> <a href="user-profile.html">
                            <h6 class="f-w-500">Web development</h6>
                          </a><span class="font-light f-w-400 f-13">12h 05m</span></div>
                      </div>
                    </td>
                    <td>$156</td>
                    <td>Illustration</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img
                            src="{{ asset('') }}assets/images/dashboard1/invest/03.jpg" alt=""></div>
                        <div class="flex-grow-1"> <a href="user-profile.html">
                            <h6 class="f-w-500">Computer science</h6>
                          </a><span class="font-light f-w-400 f-13">06h 15m</span></div>
                      </div>
                    </td>
                    <td>$695</td>
                    <td>UX/UI Design</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <div class="flex-shrink-0"><img
                            src="{{ asset('') }}assets/images/dashboard1/invest/04.jpg" alt=""></div>
                        <div class="flex-grow-1"> <a href="user-profile.html">
                            <h6 class="f-w-500">Web designer</h6>
                          </a><span class="font-light f-w-400 f-13">04h 30m</span></div>
                      </div>
                    </td>
                    <td>$364</td>
                    <td>Leadership</td>
        ...
        <div class="card schedule-card">
          <div class="card-header pb-0">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown8" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown8"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
          <div class="card-body pt-0">
            ...
            <ul class="schedule-wrapper nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"><a class="nav-link active" id="mon-tab" data-bs-toggle="tab" href="#mon"
                  role="tab" aria-controls="mon" aria-selected="false"><span>Mo </span>
                  <h6>01</h6>
                </a></li>
              ...
              <li class="nav-item"><a class="nav-link font-primary" id="sat-tab" data-bs-toggle="tab"
                  href="#sat" role="tab" aria-controls="sat" aria-selected="false"><span>Sa </span>
                  <h6>06</h6>
                </a></li>
            </ul>
          ...
          <div class="card-header">
            ...
            <div class="dropdown icon-dropdown">
              <button class="btn dropdown-toggle" id="userdropdown5" type="button" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-more-alt"></i></button>
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown5"><a class="dropdown-item"
                  href="#">Weekly</a><a class="dropdown-item" href="#">Monthly</a><a
                  class="dropdown-item" href="#">Yearly</a></div>
            </div>
          </div>
          <div class="card-body p-0">
            <div class="d-flex bg-light gap-3">
              <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                  src="{{ asset('') }}assets/images/avatar/10.jpg" alt="Use1"></div>
              <div class="flex-grow-1"><a href="user-profile.html">
            ...
            <div class="d-flex gap-3">
              <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                  src="{{ asset('') }}assets/images/avatar/4.jpg" alt="Use2"></div>
              <div class="flex-grow-1"><a href="user-profile.html">
            ...
            <div class="d-flex gap-3">
              <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                  src="{{ asset('') }}assets/images/avatar/12.jpg" alt="Use3"></div>
              <div class="flex-grow-1"><a href="user-profile.html">
